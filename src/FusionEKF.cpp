...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  ekf_.Q_ << dt2*dt2/4*noise_ax, 0, dt2*dt/2*noise_ax,0,
		  0, dt2*dt2/4*noise_ay, 0, dt2*dt/2*noise_ay,
		  dt2*dt/2*noise_ax,0, dt2*noise_ax, 0,
		  0, dt2*dt/2*noise_ay,0, dt2*noise_ay;
